...
set CLASSPATH="%SVNKIT_LIB%\svnkit-1.10.1.jar"
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\sequence-library-1.0.4.jar"
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\sqljet-1.1.12.jar"
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\jna-4.1.0.jar"
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\jna-platform-4.1.0.jar"
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\trilead-ssh2-1.0.0-build222.jar"
...
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\lz4-java-1.4.1.jar"
...
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\svnkit-cli-1.10.1.jar"
